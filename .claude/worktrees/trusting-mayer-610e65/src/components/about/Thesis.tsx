...
const PARAGRAPHS = [
  ...
  "The industry response has been dashboards — more screens, more logins, more data to interpret. But the people running these businesses aren't analysts. They're principals. They're on the floor, in the field, between locations, between properties, between deals. They need intelligence delivered to them, not waiting behind a browser tab.",
