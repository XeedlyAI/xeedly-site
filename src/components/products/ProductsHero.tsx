    ...
    <section className="relative section-dark overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pt-20 md:pt-28 pb-24 md:pb-28 text-center">
        ...
        >
          ...
          <br />
          <span className="text-[#38b6ff]">One intelligence architecture.</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 14 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2, ease: EASE }}
          className="mt-6 mx-auto max-w-[620px] text-[16px] leading-[1.6] text-[#94a3b8]"
        >
          Each product is a vertical-specific deployment of the XeedlyAI
          intelligence platform. Same event bus. Same signal engine. Same
          three-tier delivery. Different data, different rules, different
          personas.
        </motion.p>
      </div>
    </section>
