    ...
    <section className="relative section-dark py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <Link
            href="/contact"
            className="inline-flex items-center px-9 py-4 rounded-lg bg-[#38b6ff] hover:bg-[#0A8FD4] text-[#0f172a] font-bold text-[15px] transition-all"
          >
            Talk to Us
          </Link>
          <Link
          ...
          >
            Or try the Intelligence Console →
          </Link>
        </motion.div>
      </div>
    </section>
